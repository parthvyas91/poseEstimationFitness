    ...
    def draw_humans(npimg, humans, imgcopy=False):
        ...
        for human in humans:
            ...
            for i in range(common.CocoPart.Background.value):
                ...
                # logger.debug("Body Part Points: ")
                # logger.debug(center)
                # logger.debug("Body Part Name: " + getBodyPartString(i))
                #cv2.putText(npimg, "Body Part: " + getBodyPartString(i), center, cv2.FONT_HERSHEY_SIMPLEX, 0.25,
                #        (0, 255, 0), 2)
